...
- [`cases/time-under-observation/`](./cases/time-under-observation/) — Hindu cosmic cycles, Buddhist impermanence, Aboriginal Australian deep-time memory, Maya calendrics, and Hopi temporal/migration traditions tested against observable reality. The working clue is **cycles nested inside irreversible change**; science-tradition retrofits are kept as explicit failure cases.
